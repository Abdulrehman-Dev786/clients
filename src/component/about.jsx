...
function About() {
  ...
  <section id='about'>
    <div className='bg-gradient-to-b from-sky-200 to-blue-50  md:pb-20'>
      ...
      <div className=" hover:animate-pulse flex text-center items-center justify-center"><img  className='pt-9 ' src="/section-removebg-preview.png" alt="About section background" /></div>

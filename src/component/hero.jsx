...
function Hero() {
    ...
    return (
        <>
            {/* first section */}
  <section id='hero'>
    <div className="hero md:pt-20 grid bg-gradient-to-b from-slate-100 to-sky-200 md:grid-cols-1 lg:grid-cols-2  ">
      <div>
      ...
      <div>
        <div>
          <div className="img flex items-center justify-center  pt-20 hover:animate-pulse" ><img className=' h-80  ' src="/hero-removebg-preview.png" alt="Hero section background" /></div>
        </div>
      </div>
    </div>
